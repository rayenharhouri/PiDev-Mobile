 ...
 * @author louay
 */
public class AddPub extends SideMenuBaseForm {

    public AddPub(Resources res) {
        super(BoxLayout.y());
...
int id = user.getId();
*/
                publication p = new publication(1, description.getText());
                ServicePublication.getInstance().addPub(p);
                iDialog.dispose();
